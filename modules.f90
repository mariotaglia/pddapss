...
integer yes
real*8 pKA,pKB,pkD
real*8 pKAi,pKBi,pkDi
real*8 pKAf,pKBf,pkDf
integer pKAp,pKBp,pkDp
...
real*8 fB_aspol_alpha,fB_asion_alpha,fb_unas_alpha
real*8 fA_aspol_beta,fA_asion_beta,fA_unas_beta
real*8 fB_aspol_beta,fB_asion_beta,fB_unas_beta
