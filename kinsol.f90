...
fnormtol = 1.0d-7!Function-norm stopping tolerance
scsteptol = 1.0d-7 ! Function-norm stopping tolerance
!max_step = 1.0d-10
...
call fkinsetiin('MAX_SP_SETUPS', msbpres, ier)  ! Additional input information
